...
import {  collaborators, files, folders, prices, products, subscriptions, users, workspaces } from "./schema";
...
export type PriceType = InferSelectModel<typeof prices> & { products?: ProductType };
export type subscriptionType = InferSelectModel<typeof subscriptions> & {
    prices: PriceType
};

export type ProductWirhPrice = ProductType & {
    prices?: PriceType[];
  };